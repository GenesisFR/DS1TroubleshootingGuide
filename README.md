...
* [2.0 Guides](#guides)
   ...
   * [1.2 Capture the game with OBS](#capture-the-game-with-obs)
   * [1.3 Change the FOV](#change-the-fov)
   * [1.4 Convert DS saves to LOA](#convert-ds-saves-to-loa)
   * [1.5 Enable EAX](#enable-eax)
   * [1.6 Enable LOA + Extras](#enable-loa--extras)
   * [1.7 Enable MP](#enable-mp)
...
* [3.0 Issues fixed](#issues-fixed)
   * [1.1 Cannot find world:global:vosounds in gas tree](#cannot-find-world:global:vosounds-in-gas-tree)
   ...
   * [1.12 UI/cursor flickering](#ui-cursor-flickering)
